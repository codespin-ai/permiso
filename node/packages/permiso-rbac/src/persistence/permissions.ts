...
export async function grantUserPermission(
  ...
  try {
    ...
    logger.error('Failed to grant user permission', { error, orgId, userId, resourcePath, action });
...
export async function revokeUserPermission(
  ...
  try {
    ...
    logger.error('Failed to revoke user permission', { error, orgId, userId, resourcePath, action });
    return { success: false, error: error as Error };
  }
}
...
export async function getUserPermissions(
  ...
  try {
    ...
    logger.error('Failed to get user permissions', { error, orgId, userId, resourcePath, action });
    return { success: false, error: error as Error };
  }
}
...
export async function grantRolePermission(
  ...
  try {
    ...
    logger.error('Failed to grant role permission', { error, orgId, roleId, resourcePath, action });
    return { success: false, error: error as Error };
  }
}
...
export async function revokeRolePermission(
  ...
  try {
    ...
    logger.error('Failed to revoke role permission', { error, orgId, roleId, resourcePath, action });
    return { success: false, error: error as Error };
  }
}
...
export async function getRolePermissions(
  ...
  try {
    ...
    logger.error('Failed to get role permissions', { error, orgId, roleId, resourcePath, action });
    return { success: false, error: error as Error };
  }
}
...
export async function getEffectivePermissions(
  ...
  try {
    ...
    logger.error('Failed to get effective permissions', { error, orgId, userId, resourcePath, action });
    return { success: false, error: error as Error };
  }
}
...
export async function getEffectivePermissionsByPrefix(
  ...
  try {
    ...
    logger.error('Failed to get effective permissions by prefix', { error, orgId, userId, resourcePathPrefix, action });
    return { success: false, error: error as Error };
  }
}
...
export async function hasPermission(
  ...
  try {
    const result = await getEffectivePermissions(db, orgId, userId, resourcePath, action);
    ...
    logger.error('Failed to check permission', { error, orgId, userId, resourcePath, action });
    return { success: false, error: error as Error };
  }
}