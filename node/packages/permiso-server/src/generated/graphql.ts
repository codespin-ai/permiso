...
export type MutationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  assignUserRole?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationAssignUserRoleArgs, 'roleId' | 'userId'>>;
  ...
  deleteRole?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteRoleArgs, 'roleId'>>;
  deleteRoleProperty?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteRolePropertyArgs, 'name' | 'roleId'>>;
  deleteUser?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteUserArgs, 'userId'>>;
  deleteUserProperty?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteUserPropertyArgs, 'name' | 'userId'>>;
  ...
  revokeRolePermission?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationRevokeRolePermissionArgs, 'action' | 'resourceId' | 'roleId'>>;
  revokeUserPermission?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationRevokeUserPermissionArgs, 'action' | 'resourceId' | 'userId'>>;
  ...
  setRoleProperty?: Resolver<ResolversTypes['Property'], ParentType, ContextType, RequireFields<MutationSetRolePropertyArgs, 'name' | 'roleId'>>;
  setUserProperty?: Resolver<ResolversTypes['Property'], ParentType, ContextType, RequireFields<MutationSetUserPropertyArgs, 'name' | 'userId'>>;
  unassignUserRole?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationUnassignUserRoleArgs, 'roleId' | 'userId'>>;
  ...
  updateResource?: Resolver<ResolversTypes['Resource'], ParentType, ContextType, RequireFields<MutationUpdateResourceArgs, 'input' | 'resourceId'>>;
...
export type QueryResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  effectivePermissions?: Resolver<Array<ResolversTypes['EffectivePermission']>, ParentType, ContextType, RequireFields<QueryEffectivePermissionsArgs, 'resourceId' | 'userId'>>;
  effectivePermissionsByPrefix?: Resolver<Array<ResolversTypes['EffectivePermission']>, ParentType, ContextType, RequireFields<QueryEffectivePermissionsByPrefixArgs, 'resourceIdPrefix' | 'userId'>>;
  hasPermission?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<QueryHasPermissionArgs, 'action' | 'resourceId' | 'userId'>>;
  ...
  resource?: Resolver<Maybe<ResolversTypes['Resource']>, ParentType, ContextType, RequireFields<QueryResourceArgs, 'resourceId'>>;
  resources?: Resolver<ResolversTypes['ResourceConnection'], ParentType, ContextType, Partial<QueryResourcesArgs>>;
  resourcesByIdPrefix?: Resolver<Array<ResolversTypes['Resource']>, ParentType, ContextType, RequireFields<QueryResourcesByIdPrefixArgs, 'idPrefix'>>;
  role?: Resolver<Maybe<ResolversTypes['Role']>, ParentType, ContextType, RequireFields<QueryRoleArgs, 'roleId'>>;
  rolePermissions?: Resolver<Array<ResolversTypes['RolePermission']>, ParentType, ContextType, RequireFields<QueryRolePermissionsArgs, 'roleId'>>;
  roleProperty?: Resolver<Maybe<ResolversTypes['Property']>, ParentType, ContextType, RequireFields<QueryRolePropertyArgs, 'propertyName' | 'roleId'>>;
  roles?: Resolver<ResolversTypes['RoleConnection'], ParentType, ContextType, Partial<QueryRolesArgs>>;
  rolesByIds?: Resolver<Array<ResolversTypes['Role']>, ParentType, ContextType, RequireFields<QueryRolesByIdsArgs, 'ids'>>;
  user?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType, RequireFields<QueryUserArgs, 'userId'>>;
  userPermissions?: Resolver<Array<ResolversTypes['UserPermission']>, ParentType, ContextType, RequireFields<QueryUserPermissionsArgs, 'userId'>>;
  userProperty?: Resolver<Maybe<ResolversTypes['Property']>, ParentType, ContextType, RequireFields<QueryUserPropertyArgs, 'propertyName' | 'userId'>>;
